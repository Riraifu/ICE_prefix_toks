...
#     --editing_method=ICE \
#     --hparams_dir=./hparams/ICE/gpt2-xl.yaml \
#     --data_dir=./data/wikidata_recent.json \
#     --datatype='recent' \
#     --metrics_save_dir=./results/gpt2/ICE
...
#     --editing_method=ICE \
#     --hparams_dir=./hparams/ICE/gpt2-xl.yaml \
#     --data_dir=./data/wikidata_counterfact.json \
...
# python examples/run_knowedit_llama2.py \
#     --editing_method=ICE \
#     --hparams_dir=./hparams/ICE/llama-7b.yaml \
#     --data_dir=./data/zsre-origin.json \
#     --datatype='zsre' \
#     --metrics_save_dir=./results/llama-7b/ICE
...
#     --data_dir=./data/zsre_eval_1000.json \
#     --datatype='zsre' \
#     --metrics_save_dir=./results/Llama-2-7b-hf/ICE

python examples/run_knowedit_llama2.py \
    --editing_method=ICE \
    --hparams_dir=./hparams/ICE/gpt-j-6b.yaml \
    --datatype='zsre' \
    --metrics_save_dir=./results/gpt-j-6b/ICE\
    --data_dir=./data/zsre_train_10000.json \
