            ...
            data.append(
                {
                    ...
                    "target_new": record["target_new"] if "target_new" in record else record["labels"],
                    "ground_truth": record["ground_truth"] if "ground_truth" in record else None,
                    "portability_GS": record["portability"]["Generality"] if "portability" in record and "Generality" in record["portability"] else None,
                    "locality_LS": record["locality"]["Locality"] if "Locality" in record["locality"] else None,
                    "context": record["context"] if "context" in record else None,
                }
            )
